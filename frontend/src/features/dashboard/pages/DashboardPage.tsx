      ...
      <div className="mx-auto flex h-full min-h-0 w-full max-w-6xl flex-1 flex-col overflow-hidden px-4 pb-2">
        ...
        <div className="flex flex-1 min-h-0 flex-col gap-4 pt-2">
          ...
          <div className="flex-1 min-h-0">
            <div className="grid h-full gap-4 xl:grid-cols-[2fr_1fr]">
              <div className="flex min-h-0 flex-1 flex-col gap-4">
                <UpcomingLessons schedule={data.upcoming_schedule} className="flex-1 min-h-0" />
                <ContinueLearningCard lastLessonId={data.last_active_lesson_id} className="min-h-[7rem]" />
              </div>
              <div className="flex min-h-0 flex-1 flex-col gap-4">
                <SubjectProgressList subjects={data.subjects} className="flex-1 min-h-0" />
                <QuickActions className="min-h-[7rem]" />
              </div>
            </div>
          </div>
        </div>
